...
/**
 * Pill link CTA used for in-page anchors and external links (waitlist,
 * WhatsApp). `primary` is the olive pill with an arrow; `soft` is the pale
 * olive pill. For the trial/demo dialog CTAs use TrialButton/DemoButton.
 */
